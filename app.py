...
6. **「製作物」タブで成果物を記録する**
   論文・ソフトウェア・デザインなどの製作物をMarkdownで詳細に記録できます。

7. **右側のチャットで研究について相談する**
   研究プロフィールを踏まえた研究特化チャットです。

#### 使用AI
| 用途 | モデル |
|------|--------|
| 論文への質問・次の論文提案 | Groq / Llama 3.3 70B |
| 研究チャット | Groq / Llama 3.3 70B |
| 論文の検索・埋め込み | paraphrase-multilingual-MiniLM-L12-v2 |

#### 注意事項
- データはクラウドDBに保存されるため、再デプロイ後も消えません。
- 論文への質問はアップロード済みの文献のみを根拠とします。
""")
